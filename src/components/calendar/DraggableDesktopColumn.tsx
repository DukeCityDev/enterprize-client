...
export class DraggableDesktopColumn extends React.Component<Props,State>{
    ...
    render(){
        ...
        return (
            <td id={this.props.id} colSpan={1} className={`calendar-full-size-column-draggable ${this.state.isDraggedOver ? 'dragged-over': ''}`} style={{padding: 0}} onDragOver={() => {this.dragOver()}} onDragLeave={() => {this.dragOff()}}>
                {shifts}
            </td>
        );
    }
